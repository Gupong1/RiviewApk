            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(bottom: BorderSide(color: platinum.withOpacity(0.08), width: 1)),
                ),
                child: Row(
                  children: [
                    Container(
                      width: 36,
                      height: 36,
                      decoration: BoxDecoration(shape: BoxShape.circle, color: elegantBlue.withOpacity(0.2)),
                    ...
                    Expanded(
                      child: Text(
                        "ADD NEW SENDER",
                        style: TextStyle(color: platinum, fontSize: 16, fontWeight: FontWeight.w500),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.phone_rounded, color: goldAccent),
                        filled: true,
                        fillColor: slateGray.withOpacity(0.05),
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10),
                          borderSide: BorderSide(color: platinum.withOpacity(0.08)),
                        ),
                    ...
                    Row(
                      children: [
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    "CANCEL",
                                    style: TextStyle(color: platinum.withOpacity(0.9), fontSize: 13),
                                  ),
                                ),
                              ),
                            ),
                        ...
                        Expanded(
                          child: Container(
                            decoration: BoxDecoration(
                              gradient: LinearGradient(colors: [elegantBlue, softBlue]),
                              borderRadius: BorderRadius.circular(10),
                            ),
                            child: ElevatedButton(
                              ...
                              child: Text(
                                "CONTINUE",
                                style: TextStyle(color: platinum, fontSize: 13),
                              ),
                            ),
                          ),
                        ),
            ...
            children: [
                  ...
                  children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "PHONE NUMBER",
                                  style: TextStyle(color: platinum.withOpacity(0.6), fontSize: 10),
                                ),
                                const SizedBox(height: 4),
                                Text(number, style: TextStyle(color: platinum, fontSize: 14)),
                              ],
                            ),
                          ),
                        ],
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: elegantBlue.withOpacity(0.2), width: 1),
                      ),
                      child: Center(
                        child: Column(
                          children: [
                            Text(
                              "PAIRING CODE",
                              style: TextStyle(color: platinum.withOpacity(0.7), fontSize: 12),
                            ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          _buildInstructionStep("1", "Open WhatsApp", "Go to Settings menu"),
                          const SizedBox(height: 8),
                          _buildInstructionStep("2", "Linked Devices", "Tap on 'Linked Devices' option"),
                          const SizedBox(height: 8),
                          _buildInstructionStep("3", "Link a Device", "Select 'Link a Device'"),
                          const SizedBox(height: 8),
                          _buildInstructionStep("4", "Enter Code", "Type the 6-digit code above"),
                        ],
                      ),
                    ),
                  ],
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(top: BorderSide(color: platinum.withOpacity(0.08), width: 1)),
                ),
                child: Row(
                  children: [
                    Expanded(
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: Center(
            child: Text(number, style: TextStyle(color: platinum, fontSize: 10)),
          ),
        ),
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: TextStyle(color: platinum, fontSize: 13)),
              const SizedBox(height: 2),
              Text(description, style: TextStyle(color: platinum.withOpacity(0.7), fontSize: 11)),
            ],
          ),
        ),
      ],
              ...
              child: Row(
                children: [
                  Container(
                    width: 32,
                    height: 32,
                    decoration: BoxDecoration(shape: BoxShape.circle, color: errorRed.withOpacity(0.2)),
                    child: Icon(Icons.warning_amber_rounded, color: errorRed, size: 18),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Text(
                      "CONFIRM DELETE",
                      style: TextStyle(color: platinum, fontSize: 14, fontWeight: FontWeight.w500),
                    ),
                  ),
                ],
              ),
              ...
              child: Column(
                children: [
                  Text(
                    ...
                    style: TextStyle(color: platinum.withOpacity(0.8), fontSize: 13),
                  ),
                  const SizedBox(height: 24),
                  Row(
                    children: [
      ...
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                child: Center(child: Icon(Icons.send_rounded, color: platinum, size: 22)),
              ),
                ...
                child: Row(
                  children: [
                    Container(
                      width: 6,
                      height: 6,
                      decoration: BoxDecoration(shape: BoxShape.circle, color: successGreen),
                    ),
                    const SizedBox(width: 8),
                    Text(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Colors.transparent, elegantBlue.withOpacity(0.1), Colors.transparent],
              ),
            ),
          ),
        ],
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            ...
            if (isActive) BoxShadow(color: elegantBlue.withOpacity(0.1), blurRadius: 30, spreadRadius: 2),
          ],
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: Center(child: Icon(Icons.phone_android_rounded, color: platinum, size: 22)),
                  ),
                  const SizedBox(width: 16),
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(phone, style: TextStyle(color: platinum.withOpacity(0.6), fontSize: 13)),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Row(
                      children: [
                        Container(width: 5, height: 5, decoration: BoxDecoration(shape: BoxShape.circle, color: successGreen)),
                        const SizedBox(width: 5),
                        Text("ONLINE", style: TextStyle(color: successGreen, fontSize: 10)),
                      ],
                    ),
                  ),
                ],
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Colors.transparent, slateGray.withOpacity(0.2), Colors.transparent],
                  ),
                ),
              ),
              const SizedBox(height: 24),
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.refresh_rounded, color: platinum.withOpacity(0.9), size: 16),
                              const SizedBox(width: 8),
                              Text("REFRESH", style: TextStyle(color: platinum.withOpacity(0.9), fontSize: 12)),
                            ],
                          ),
                        ),
                      ),
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.delete_outline_rounded, color: errorRed, size: 16),
                              const SizedBox(width: 8),
                              Text("DELETE", style: TextStyle(color: errorRed, fontSize: 12)),
                            ],
                          ),
                        ),
                      ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: slateGray.withOpacity(0.05),
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: platinum.withOpacity(0.05), width: 1),
                ),
                child: Row(
                  children: [
                    Icon(Icons.info_outline_rounded, color: goldAccent, size: 14),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.phone_iphone_rounded, color: platinum.withOpacity(0.3), size: 40),
            ),
            const SizedBox(height: 32),
            Text("NO SENDERS", style: TextStyle(color: platinum, fontSize: 24, fontWeight: FontWeight.w300, letterSpacing: 2)),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.transparent, elegantBlue.withOpacity(0.3), Colors.transparent],
                ),
              ),
            ),
            const SizedBox(height: 24),
            Container(
              ...
              child: Column(
                children: [
                  Icon(Icons.add_circle_outline_rounded, color: goldAccent, size: 28),
                  const SizedBox(height: 16),
                  Text(
                    "Add your first WhatsApp sender\nto start using premium features",
                    textAlign: TextAlign.center,
                    style: TextStyle(color: platinum.withOpacity(0.7), fontSize: 13),
                  ),
                ],
              ),
            ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.error_outline_rounded, color: errorRed, size: 32),
            ),
            const SizedBox(height: 24),
            Text(
              "CONNECTION ERROR",
              style: TextStyle(color: platinum, fontSize: 18, fontWeight: FontWeight.w400, letterSpacing: 1),
            ),
            const SizedBox(height: 16),
            Container(
              padding: const EdgeInsets.all(16),
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      "RETRY CONNECTION",
                      style: TextStyle(color: platinum, fontSize: 12, fontWeight: FontWeight.w500, letterSpacing: 0.8),
                    ),
                  ],
                ),
              ),
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(colors: [elegantBlue, softBlue]),
          boxShadow: [
            BoxShadow(color: elegantBlue.withOpacity(0.3), blurRadius: 12, spreadRadius: 2),
          ],
        ),
